...
#from PIL import ImageTk,Image  #python supports images of ppm or pgm.ImageTk is used for converting pics of other formats into this format
...
connection = mysql.connect(host='localhost',user='root',password='root123')
